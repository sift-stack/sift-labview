	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support" Type="Folder">
			<Item Name="asynchronous-system-exec-v2.0.0" Type="Folder">
				<Item Name="serenial.io-ase" Type="Folder">
					<Item Name="ase" Type="Folder">
						<Item Name="serenial.io-ase.32.dll" Type="Document" URL="../Support/asynchronous-system-exec-v2.0.0/serenial.io-ase/ase/serenial.io-ase.32.dll"/>
						<Item Name="serenial.io-ase.64.dll" Type="Document" URL="../Support/asynchronous-system-exec-v2.0.0/serenial.io-ase/ase/serenial.io-ase.64.dll"/>
						<Item Name="serenial.io-ase.64.so" Type="Document" URL="../Support/asynchronous-system-exec-v2.0.0/serenial.io-ase/ase/serenial.io-ase.64.so"/>
					</Item>
					<Item Name="configuration" Type="Folder"/>
					<Item Name="serenial.io-ase.lvlib" Type="Library" URL="../Support/asynchronous-system-exec-v2.0.0/serenial.io-ase/serenial.io-ase.lvlib"/>
				</Item>
				<Item Name="serenial.io-ase.console" Type="Folder">
					<Item Name="serenial-io.ase.console.lvlib" Type="Library" URL="../Support/asynchronous-system-exec-v2.0.0/serenial.io-ase.console/serenial-io.ase.console.lvlib"/>
				</Item>
				<Item Name="serenial.io-ase.example" Type="Folder">
					<Item Name="Example Custom ID" Type="Folder"/>
					<Item Name="Example Custom Regex" Type="Folder"/>
					<Item Name="serenial.io-ase.example.lvlib" Type="Library" URL="../Support/asynchronous-system-exec-v2.0.0/serenial.io-ase.example/serenial.io-ase.example.lvlib"/>
				</Item>
				<Item Name="serenial.io-ase.test" Type="Folder">
					<Item Name="Bad Regex" Type="Folder"/>
					<Item Name="Custom ID" Type="Folder"/>
					<Item Name="Custom Regex" Type="Folder"/>
					<Item Name="serenial.io-ase.test.lvlib" Type="Library" URL="../Support/asynchronous-system-exec-v2.0.0/serenial.io-ase.test/serenial.io-ase.test.lvlib"/>
				</Item>
				<Item Name="utilities" Type="Folder">
					<Item Name="Real-Time" Type="Folder">
						<Item Name="ASE Real-Time.lvproj" Type="Document" URL="../Support/asynchronous-system-exec-v2.0.0/utilities/Real-Time/ASE Real-Time.lvproj"/>
					</Item>
					<Item Name="Library Error List.txt" Type="Document" URL="../Support/asynchronous-system-exec-v2.0.0/utilities/Library Error List.txt"/>
					<Item Name="Post-Build Action.vi" Type="VI" URL="../Support/asynchronous-system-exec-v2.0.0/utilities/Post-Build Action.vi"/>
					<Item Name="Pre-Build Action.vi" Type="VI" URL="../Support/asynchronous-system-exec-v2.0.0/utilities/Pre-Build Action.vi"/>
					<Item Name="serenial.io-ase fix shared library paths.vi" Type="VI" URL="../Support/asynchronous-system-exec-v2.0.0/utilities/serenial.io-ase fix shared library paths.vi"/>
					<Item Name="serenial.io-ase tidy unused files.vi" Type="VI" URL="../Support/asynchronous-system-exec-v2.0.0/utilities/serenial.io-ase tidy unused files.vi"/>
					<Item Name="VI-Analyzer-config.viancfg" Type="Document" URL="../Support/asynchronous-system-exec-v2.0.0/utilities/VI-Analyzer-config.viancfg"/>
					<Item Name="VI-Analyzer-Dict.txt" Type="Document" URL="../Support/asynchronous-system-exec-v2.0.0/utilities/VI-Analyzer-Dict.txt"/>
				</Item>
